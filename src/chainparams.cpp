...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.JattCoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.JattCointools.com", true);
        vSeeds.emplace_back("dnsseed.JattCoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.JattCointools.com", true);
        vSeeds.emplace_back("seed-b.JattCoin.loshan.co.uk", true);
