...
const char * const BITCOIN_CONF_FILENAME = "JattCoin.conf";
const char * const BITCOIN_PID_FILENAME = "JattCoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "JattCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/JattCoin";
#else
    // Unix
    return pathRet / ".JattCoin";
#endif
#endif
}
