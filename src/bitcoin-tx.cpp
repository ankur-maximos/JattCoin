...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s JattCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  JattCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded JattCoin transaction") + "\n" +
              "  JattCoin-tx [options] -create [commands]   " + _("Create hex-encoded JattCoin transaction") + "\n" +
              "\n";
